...
% todo change top (platform) angles
...
% 3-2-6 Configuration is when the legs below the knee are perpendicular to the
%   base at all time, but above the knee meet the platform at exactly 60º apart
%   about the z axis
...
min_joint_length = 16.7; %[inches], from CAD % TODO
max_joint_length = 24.7; %[inches], from CAD % TODO
...
if plots
    ...
    legend('Actuator 1', 'Actuator 2', 'Actuator 3', 'Actuator 4', 'Actuator 5', 'Actuator 6', 'Min Length', 'MaxLength', 'Location', 'north')
